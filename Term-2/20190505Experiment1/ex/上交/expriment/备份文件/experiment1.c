...
SCGtable *gra_cou_search(Stable *pstu,Ctable *pcou,Gtable *pgra);
...
SCGtable *gra_cou_search(Stable *pstu,Ctable *pcou,Gtable *pgra){
    ...
    fclose(fp);
    printf("All information is shown in the table below: \n");
    return pscg;
}
...
void gra_below_sixty(SCGtable *pscg){
    ...
    printf("Information on scores below 60 is shown in the table below: \n");
...
int main(){
        ...
        scanf("%d",&choice);
            switch (choice){
                ...
                stu_sorted(&pstu);  
                printf("Information of students is shown in the table below: \n");
                ...
                cou_sorted(&pcou);
                printf("Information of courses is shown in the table below: \n");
                ...
                cou_init(&pcou);                            //课程链表初始化
                gra_init(&pgra);                            //成绩链表初始化
                pscg = gra_cou_search(pstu,pcou,pgra);      //所有课程的成绩信息
                printf("All information is shown in the table below: \n");
                gra_output_all(pgra);                       //成绩信息打印
                break;

                case 8:
                pscg = gra_cou_search(pstu,pcou,pgra);      //所有课程的成绩信息
                printf("The course's information is shown in the table below: \n");
                ...
                case 10:
                printf("Information of students in reverse order is shown in the table below: \n");
                stack(pstu);                                //用栈逆序输出
                break;
